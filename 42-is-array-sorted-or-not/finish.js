...
const arraySortInfo = (inputArray) => {
    if (inputArray.some((element) => typeof element !== 'number')) { // можно использовать метод find(), но он будет плохо работать, если в массиве будет пропуск уэлемента.
        return 'Некоторые числа не являются числами';
    }
