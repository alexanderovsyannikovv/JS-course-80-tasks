...
// const carInfo = object => object.price <= 20000 ? `Цена автомобиля ${object.brand} - ${object.price}$ и это дешёвая машина`
//                                                 : `Цена автомобиля ${object.brand} - ${object.price}$ и это дорогая машина`;

// OR
const carInfo = ({ brand, price }) => `Цена автомобиля ${brand} - ${price}$ и это ${price <= 20000 ? 'дешёвая машина' : 'дорогая машина'}`; 
