...
/**
 * The function should return the difference between the first and second parameter.
 * @param {number} a 
 * @param {number} b 
 * @returns {number} difference between the first and second parameter.
 */
function diff(a, b) {
    return a - b;
}

const hehe = diff(12, 5);
